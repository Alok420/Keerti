                        ...
                        <div class="formcontainer">
                            <form class="form-horizontal" method="POST" action="../../controller/Student/EducationUpdate.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">          
                                        <input type="text" value="<?php echo $one["skill_last_used_year_month"]; ?>" class="form-control" id="skilllastusedyear/month" placeholder="Enter Skill Last Used Year/Month" name="skill_last_used_year_month">
                                    </div>
                                </div>
                                <div class="form-group">        
                                    ...
                                    <input type="hidden" name="tbname" value="skill_set" >
                                </div>
                                <div class="form-group">        
                                    <div class="col-sm-offset-5 col-sm-7">
