                        ...
                        <div class="formcontainer">
                            <form class="form-horizontal" method="POST" action="../../controller/Student/EducationUpdate.php">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-5" for="employername">Recruiter name:</label>
                                    <div class="col-sm-7">
                                        <input value= "<?php echo $one["employer_name"]; ?>" type="text" class="form-control" id="employername" placeholder="Enter Recruiter Name" name="employer_name">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-5" for="statuspreviouscurrentemployer">Status - Previous/Current Recruiter:</label>
                                    <div class="col-sm-7">          
                                        <input   type="text" class="form-control" id="statuspreviouscurrentemployer" placeholder="Status Previous Current Recruiter" value="<?php echo $one["status_previous_current_employer"]; ?>" name="status_previous_current_employer">
                                    </div>
                                </div>
                                <div class="form-group">        
