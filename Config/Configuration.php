...
function tablesdata() {
    $tables = array(
        ...
        "chat" => array("id" => "int:10:PRIMARY KEY AUTO_INCREMENT", "message" => "varchar:text", "fromid" => "int", "fromtype" => "varchar:30", "sendtoid" => "int", "sendtotype" => "varchar:30", "mtime" => "datetime", "bapproval" => "int", "mbapproval" => "int"),
        ...
        "job_preference" => array("id" => "int:10:PRIMARY KEY AUTO_INCREMENT", "job_type" => "varchar:20", "employment_type" => "varchar:50", "will_to_work_in_shifts" => "varchar:20", "relocate" => "varchar:20"),
        "upload_other_data" => array("id" => "int:10:PRIMARY KEY AUTO_INCREMENT", "upload_letter" => "text:500", "upload_resume" => "text:500", "self_introduction" => "text:500", "profiletitle" => "varchar:100"),
...
//        "Educational_Qualifications" => arr ay("id" => "int:10:10:PRIMARY KEY AUTO_INCREMENT","basic_qualification"=>"varchar:20","fulltime_parttime"=>"varchar:5","spacialization"=>"varchar:500","university_board_institute"=>"varchar:20","year_of_passing"=>"varchar:5")
    );
//    ,"industryyoubelong"=>"varchar:50","currentdesignation"=>"varchar:50","skill"=>"text","experience"=>"int:10","skillusedyear"=>"date",""=>""
    return $tables;
}
