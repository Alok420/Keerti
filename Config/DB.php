            ...
            <div class="profile-container" style=" margin: auto;
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <form action="../controller/DeleteController.php" method="post" enctype="multipart/form-data">
...
//            echo "<td><button class='btn btn-outline-success btn-sm' data-toggle='modal' data-target='#deletemodel' onclick='deleteRecord(" . $row["id"] . ",\"" . $table . "\")' id='deletebtn'>Delete</button></td>";
        ...
        ';
            ...
            while ($row = $list->fetch_assoc()) {
                ...
                if ($externallinks != "") {
                    $link = "<td><div><a href='$externallinks id=" . $row['id'] . "'>Detail</a></div></td>";
                    echo $link;
                }
                ?>
            </tr>
...
//                                    echo "$SQL";
    ...
    public function sendBack($server, $info = "?info=Record added / modified successfully") {
        $returnpath = "";
