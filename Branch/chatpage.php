    ...
    <div class="container-fluid" style="margin-top: -20px;">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <?php
                $sql = "select * from chat where (sender_id=" . $_SESSION["loggedinid"] . " or receiver_id=" . $_SESSION["loggedinid"] . ") and (senderuseretype='branch' or receiveruseretype='branch')";
                        ...
                        <div class="mainbox">
                            ...
                            while ($one = $data->fetch_assoc()) {
                                ...
                                if ($one["senderuseretype"] == "branch") {
                                    ...
                                    <?php
                                } else if ($one["receiveruseretype"] == "branch") {
                                    ?>
