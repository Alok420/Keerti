        ...
        <div class="container-fluid allbranchContainer">
            <div class="row">
                ...
                <div class="col-sm-9 maincolumn">
                    ...
                    <?php
                    $sql = "select * from hiring where requestedBy='candidates' and candidates_id in(select id from candidates where branches_id=" . $_SESSION["loggedinid"] . ")";
                    if (isset($_GET["branchapproval"])) {
                        $employerapproval = $_GET["branchapproval"];
                        $sql = "select * from hiring where requestedBy='candidates' and candidates_id in(select id from candidates where branches_id=". $_SESSION["loggedinid"].") and branchapproval=" . $_GET['branchapproval'];
                    }
                    $data = $conn->query($sql);
                        ...
                        <div class="row listbox">
                           ...
                           <!--<span style="font-size:2em; transform:scaleX(3);">&zigrarr;</span>-->
                            ...
                            <div class="col-sm-3">
                                ...
                                <?php
                                echo $one["branchapproval"] == 0 ? "<button id='approve' class='btn btn-success' onclick='approval(\"1\",\"" . $one['id'] . "\",\"hiring\")'>Approvel</button>" : "<button id='approved' onclick='approval(\"0\",\"" . $one['id'] . "\",\"hiring\")' class='btn btn-default'>Approved</button>";
                                ?>
                                <br><br>
                                <?php
