...
//                $sql = "select * from chat where (sender_id=" . $_SESSION["loggedinid"] . " or receiver_id=" . $_SESSION["loggedinid"] . ") and (senderuseretype='mainbranch' or receiveruseretype='mainbranch')";
                    ...
                    <div class="col-sm-12">
                        <div class="mainbox">
                            ...
                            while ($one = $data->fetch_assoc()) {
                                ...
                                if ($one["senderuseretype"] == "mainbranch") {
                                    ?>
                                    <div class="sendermsg">
                                        <?php
                                        echo $one["mesaage"] . "<br>";
                                    ...
                                    <?php
                                } else if ($one["receiveruseretype"] == "mainbranch") {
                                    ?>
