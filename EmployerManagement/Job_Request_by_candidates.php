                ...
                <div class="col-sm-9 maincolumn">
                    ...
                    while ($one = $data->fetch_assoc()) {
                        ...
                        <div class="row listbox">
                            ...
                            <div class="col-sm-3">
                                <?php
                                echo $one["branchapproval"] == 0 ? "<button id='approve' class='btn btn-success' disabled onclick='approval(\"1\",\"" . $one['id'] . "\",\"hiring\")'>Branch Approvel</button>" : "<button disabled id='approved' onclick='approval(\"0\",\"" . $one['id'] . "\",\"hiring\")' class='btn btn-default'>Branch Approved</button>";
                                ?>
                                <br><br>
                                <?php
