    ...
    <div class="container-fluid" style="margin-top: -20px;">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                $sql = "select * from chat where (sender_id=" . $_SESSION["loggedinid"] . " or receiver_id=" . $_SESSION["loggedinid"] . ") and (senderuseretype='employer' or receiveruseretype='employer')";
                    ...
                    <div class="col-sm-12">
                        <div class="mainbox">
                            ...
                            while ($one = $data->fetch_assoc()) {
                                ...
                                if ($one["senderuseretype"] == "employer") {
                                    ?>
                                    <div class="sendermsg">
                                        <?php
                                        echo $one["mesaage"] . "<br>";
                                    ...
                                    <?php
                                } else if ($one["receiveruseretype"] == "employer") {
                                    ?>
