...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-weight: bold; font-size: 35px; box-sizing: border-box; padding-top: 25px;">Recruiters Admin panel</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="Recruiter_page.php">Dashboard</a></li>
                <li id="envelopenotification"><a class="#" href="chatpage.php"><span class="glyphicon glyphicon-envelope">
