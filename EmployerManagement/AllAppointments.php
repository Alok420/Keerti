...
<?php include './recruiter_page.css'; ?>
            ...
            *{
            ...
            .row-title{
                margin-top: 15px;
                box-shadow: 2px 2px #08507F!important;
            }
            .row-title {
            margin:0px; 
            padding: 20px; 
        ...
        <div class="container-fluid allbranchContainer">
            <div class="row">
                ...
                <div class="col-sm-9 maincolumn">
                    ...
                    <div class="filter">
                        <h5 style="font-size: 20px; font-weight: bold; color: #08507F; letter-spacing: 1px;">Filter: </h5>
                    ...
                    <?php
                    $sql = "select * from appointment where  hiring_id in(select id from hiring where employers_id=" . $_SESSION["loggedinid"] . ")";
