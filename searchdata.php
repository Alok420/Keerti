            ...
            <div class=" container-fluid">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        $sql = "select * from jobpost where upper(job_title) like upper('%$search_param%') and employers_id in (select id from employers where Address_office like '%$location%')";
                        $data = $conn->query($sql);
                            ...
                            <div class="employeeprofilecard" style="margin-top: 20px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <p id="Jobdesc"><?php echo $row["Package_Ranged_Offered"]; ?></p>
                                        <div class="btn3">
